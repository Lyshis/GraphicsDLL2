...
{
	// **** Pas besoin que la DLL fasse le save ****
	//USES_CONVERSION;
...
void CElement::Draw(CModeler1View * pView, CDC* pDC)
{
	...
	graphics.ScaleTransform(ptrManager->m_fZoomFactor, ptrManager->m_fZoomFactor);
